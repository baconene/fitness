import { APPARATUS_DEMOS, FORM_REVIEW_DEMOS } from './exerciseApparatusRefinements.js';
/**
...
export const demoFor = (slug, name = null) => {
    ...
    const artworkVersion = FORM_REVIEW_DEMOS.includes(key) ? 'form-9' : APPARATUS_DEMOS.includes(key) ? 'apparatus-8' : MOTION_DEMOS.includes(key) ? 'motion-7' : FORM_DEMOS.includes(key) ? 'form-6' : CORRECTED_DEMOS.includes(key) ? 'equipment-5' : key === 'incline-treadmill-walk' ? 'treadmill-4' : 'wireframe-3';
