...
const MOVEMENT_CUES = {
    ...
    'hollow-body-hold': 'keep your lower back grounded with shoulders and straight legs slightly raised; hold and breathe.',
    'incline-bench-press': 'support your back on the incline bench, keep feet planted, and lower the bar toward your upper chest before pressing up.',
    'incline-dumbbell-press': 'support your back on the incline bench and press both dumbbells over your upper chest with control.',
    'incline-dumbbell-curl': 'rest against the inclined backrest, let your upper arms hang, and curl without swinging your elbows.',
    'incline-push-up': 'plant your hands on the raised bench and lower your chest toward it while keeping your trunk and legs aligned.',
    'pike-push-up': 'keep hips high and hands planted, bend your elbows to lower your head, then press back up.',
    'inverted-row': 'hold the fixed bar with heels grounded, pull your chest toward the bar, and lower as one straight body.',
    'jump-rope': 'turn the rope with small wrist movements and use low, light jumps as it passes beneath your feet.',
    'landmine-press': 'hold the end of the anchored bar at chest height and press upward and forward along its arc.',
    'lat-pulldown': 'sit with thighs beneath the pad, pull the bar in front toward your upper chest, and return under control.',
    'leg-extension': 'sit against the backrest with shins behind the roller; extend and lower your knees without lifting your hips.',
    'leg-press': 'keep your back supported and feet on the sled; press along the rails without locking your knees.',
    'lying-leg-curl': 'lie face down with ankles beneath the roller and curl your heels up while keeping hips on the bench.',
    'machine-chest-press': 'sit against the backrest and press the handles forward, then return with control.',
    'rear-delt-fly': 'hinge at the hips, hold your trunk steady, and raise the dumbbells out to the sides with soft elbows.',
    'russian-twist': 'sit with bent knees and feet grounded, lean back slightly, and rotate your chest and hands together.',
    'side-plank': 'support yourself on one forearm and stacked feet, keep your hips lifted, and hold a straight body line.',
